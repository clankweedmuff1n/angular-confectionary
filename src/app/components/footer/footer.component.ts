...
@Component({
  ...
  imports: [],
  template: `
    <footer class="flex flex-col mt-28 w-full">

      <div class="flex flex-col gap-2 m-auto">
        <div class="flex gap-2">
          <button
            class="flex justify-center items-center hover:bg-[#cc39a4] hover:scale-110 group/ig w-32 h-32 outline-0 bg-white shadow-3xl transition-all rounded-first-card ">
            <svg class="mt-[1.5em] ml-[1.2em] group-hover/ig:scale-110 group-hover/ig:text-white text-[#cc39a4]"
          ...
          <button
            class="flex justify-center items-center hover:bg-[#03A9F4] hover:scale-110 group/tg w-32 h-32 outline-0 bg-white shadow-3xl transition-all rounded-second-card">
            <svg class="text-[#03A9F4] group-hover/tg:scale-110 group-hover/tg:text-white mt-[1.5em] ml-[-.9em]"
        ...
        <div class="flex gap-2">
          <button
            class="flex justify-center items-center hover:bg-[#8c9eff] hover:scale-110 group/vb w-32 h-32 outline-0 bg-white shadow-3xl transition-all rounded-third-card">
            <svg class="mt-[-.6em] ml-[1.2em] text-[#8c9eff] group-hover/vb:scale-110 group-hover/vb:text-white" xmlns="http://www.w3.org/2000/svg" width="32"
          ...
          <button
            class="flex justify-center items-center group/wa hover:bg-[#00ff00] hover:scale-110 w-32 h-32 outline-0 bg-white shadow-3xl transition-all rounded-fourth-card">
            <svg class="mt-[-.9em] ml-[-1.2em] text-[#00ff00] group-hover/vb:scale-110 group-hover/wa:text-white" xmlns="http://www.w3.org/2000/svg" width="32"
                 height="32" viewBox="0 0 24 24">
              <g fill="none">
      ...
      <!--<div class="flex flex-col justify-center gap-16">
        <div class="m-auto flex w-fit flex-col md:flex-row gap-16">

          <div class="w-fit p-4 rounded-full bg-menu-green shadow-3xl">
        ...
        <div class="flex w-fit m-auto flex-col md:flex-row gap-16">
      ...
      <div class="bg-menu-beige-dark mt-28">
